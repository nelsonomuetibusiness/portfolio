        ...
        <div className="grid gird-cols-1 lg:grid-cols-3 gap-4 mt-10">
            <Card className="col-span-1 lg:col-span-2 border-none bg-gray-100 p-8">
                <h1 className="text-4xl lg:text-4xl">
                    Passionate and Versatile FullStack Developer who loves to create
                </h1>
                <p className="mt-4 text-muted-foreground lg:text-2xl">
                    I am a software engineer with a passion for creating efficient and
                    user-friendly sotfware and web applications. I have experience in developing
            ...
            <div className="col-span-1">
                <Image
                    src={me}
                    alt="Nelson Omueti"
                    className="h-[500px] object-cover rounded-lg w-full hover:scale-95"
                />
            </div>
        </div>
    );
